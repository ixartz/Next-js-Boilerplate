...
![Early visual design explorations: applying the brand designers work to a single UI component](/trustify/trustify-casestudy-01_ozn2or.png)
...
![Early homepage explorations](/trustify/trustify-casestudy-02_g42wlg.png)
...
![Different ways of organising users’ activity and progress through the verification process](/trustify/trustify-casestudy-03_emrt7f.png)
...
![Quick wires exploring different layouts given new priorites](/trustify/trustify-casestudy-04_ey7lqi.png)

![Exploration structures for the app with the new, camera-centric functionality](/trustify/trustify-casestudy-05_oe0cqu.png)
...
![New visuals and simplified IA applied to final app](/assets/trustify/trustify-casestudy-06.png)
...
![Style guide to ease developer handoff](/trustify/trustify-style-guide_o0i4it.png)
