# Starter kit with Next.js 16+, Tailwind CSS 4, and TypeScript.
...
- Roles & Permissions
- Shadcn UI
- End-to-End Typesafety with oRPC
- Stripe Payment
- Light / Dark mode.
...
npm install
```
All dependencies are updated every month.
