...
const NavigationMenu = ({ ref, className, children, ...props }: React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Root> & { ref: React.RefObject<React.ComponentRef<typeof NavigationMenuPrimitive.Root>> }) => {
  const viewportRef = React.useRef<React.ComponentRef<typeof NavigationMenuPrimitive.Viewport>>(null);
  ...
  return (
    ...
    >
      {children}
      <NavigationMenuViewport ref={viewportRef as React.RefObject<HTMLDivElement>} />
    </NavigationMenuPrimitive.Root>
  );
};
